...
**Read it fully before writing any code.** If you are an AI assistant, treat
every rule here as a strict constraint unless the developer explicitly overrides it.
...
> Follow the migration workflow in CLAUDE.md and the existing patterns in
...
Follow the CLAUDE.md workflow. Start with the migration if DB changes are needed,
