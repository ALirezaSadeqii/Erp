...
export const metadata = {
  ...
  description: "Gelir, gider ve hizmet raporlarını tarih aralığına göre inceleyin.",
};
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Tarih aralığı seçerek gelir, gider ve hizmet raporlarını görüntüleyin.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-6">
          ...
          {!result && (
            <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white py-20 text-center shadow-sm">
              ...
              <p className="text-lg font-semibold text-slate-700">Rapor için tarih aralığı seçin</p>
              <p className="mt-1 text-sm text-slate-400">Başlangıç ve bitiş tarihlerini seçip &ldquo;Raporu Getir&rdquo;e tıklayın.</p>
            </div>
          )}
                      ...
                      <table className="min-w-full divide-y divide-slate-100 text-sm">
                        <thead>
                          <tr className="bg-slate-50">
                            <th className="py-3 pl-4 pr-6 text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                              Plaka
                            </th>
                            ...
                            <tr key={v.id} className="transition-colors hover:bg-slate-50">
                              ...
                              <td
                                className={`whitespace-nowrap px-4 py-3 text-right font-bold ${
                                  v.netProfit >= 0 ? "text-emerald-700" : "text-rose-600"
                                }`}
                              >
                        ...
                        <tfoot className="border-t-2 border-slate-200 bg-slate-50">
                          <tr>
                            <td colSpan={4} className="py-3 pl-4 pr-6 text-xs font-semibold uppercase tracking-wider text-slate-500">
                              Toplam
                            </td>
                            <td className="whitespace-nowrap px-4 py-3 text-right font-bold text-slate-900">
                              {formatCurrency(summary.totalIncome)}
                            </td>
                            <td className="whitespace-nowrap px-4 py-3 text-right font-bold text-slate-500">
                              {formatCurrency(summary.totalExpenses)}
                            </td>
                            <td
                              className={`whitespace-nowrap px-4 py-3 text-right font-extrabold ${
                                summary.netProfit >= 0 ? "text-emerald-700" : "text-rose-600"
                              }`}
                            >
